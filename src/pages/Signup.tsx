      ...
      <div className="w-full max-w-[420px] animate-fadeInUp">
        <div className="bg-white/10 backdrop-blur-xl border border-white/[0.18] rounded-[20px] shadow-[0_8px_32px_rgba(0,0,0,0.2)] p-12">
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            <div>
              <label htmlFor="name" className="block text-[0.95rem] font-medium text-white mb-2">
                Name
              </label>
              <input
                type="text"
          ...
          <button
            onClick={() => navigate('/')}
            className="w-full bg-transparent border border-white/30 text-white font-medium py-3 rounded-[10px] transition-all duration-300 hover:bg-white/10 hover:border-white/40 mt-4"
          >
            Back to Home
          </button>
        </div>
